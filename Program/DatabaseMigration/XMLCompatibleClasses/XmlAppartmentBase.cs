namespace DatabaseMigration.XMLCompatibleClasses
{
    ...
    /// которые можно отнести к квартирам (малосемейки,
    /// квартиры, аренда жилья,
    /// </summary>
    public abstract class XmlAppartmentBase : XmlBaseRealtyObject
    {
        /// <summary>
        /// Район.
        /// </summary>
        ...
        /// <summary>
        /// Добавить специфичные для квартир свойства.
        /// </summary>
